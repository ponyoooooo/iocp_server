...
public:
    ...
    uint16_t EnterUser(int32_t groundNumber, User* user) const;
    int16_t LeaveUser(int32_t groundNumber, User* user) const;
    HuntingGround* GetGroundByNumber(int32_t number) const;
